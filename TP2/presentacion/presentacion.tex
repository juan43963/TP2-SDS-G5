...
\graphicspath{{../data/plots/}{./}{../informe/figs/}}
...
% Diapositiva divisoria automatica por seccion (guia 1.13).
\AtBeginSection[]{%
  \begin{frame}[plain]
    \vfill
    \centering
...
% Bloque de parametros al costado de una figura (guia 1.7).
  ...
  \begin{columns}[c]
    ...
    \begin{column}{0.38\textwidth}
      \begin{itemize}
        ...
        \item Salida en texto plano; análisis y animación en Python, aparte.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Vicsek: dinámica característica}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[height=0.52\textheight]{frame_vicsek_rho2_ordenado.png}\\[2pt]
      {\scriptsize $\eta = 1{,}0$}\\
      {\tiny\color{blue}\url{https://youtu.be/PENDIENTE-1}}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[height=0.52\textheight]{frame_vicsek_rho2_desordenado.png}\\[2pt]
      {\scriptsize $\eta = 4{,}0$}\\
      {\tiny\color{blue}\url{https://youtu.be/PENDIENTE-2}}
    \end{column}
  \end{columns}
  \vspace{0.4em}
  \centering \params{$\rho = 2$ \ ($N = 200$), \ $L = 10$, \ $r_c = 1$. \ Fotograma en $t = 850$. \ Color según el ángulo de la velocidad.}
\end{frame}
...
\begin{frame}{Vicsek: evolución temporal de la polarización}
  \begin{columns}[c]
    \begin{column}{0.70\textwidth}
      \centering\includegraphics[height=0.72\textheight,keepaspectratio]{va_t_vicsek_rho2.png}
    \end{column}
...
\begin{frame}{Vicsek: polarización en función del ruido}
  \begin{columns}[c]
    \begin{column}{0.70\textwidth}
      \centering\includegraphics[height=0.72\textheight,keepaspectratio]{va_eta_vicsek.png}
    \end{column}
    \begin{column}{0.28\textwidth}
      \params{
      Vicsek\\
...
\begin{frame}{Vicsek: evolución temporal de la componente gigante}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering\includegraphics[height=0.62\textheight,keepaspectratio]{S_t_vicsek_rho2.png}\\
      {\scriptsize $\rho = 2$ \ ($N = 200$)}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering\includegraphics[height=0.62\textheight,keepaspectratio]{S_t_vicsek_rho1_pi.png}\\
      {\scriptsize $\rho = 1/\pi$ \ ($N = 32$)}
    \end{column}
  \end{columns}
  \vspace{0.3em}
  \centering \params{Vicsek, \ $L = 10$, \ $r_c = 1$. \ Izquierda: $2\times10^{3}$ pasos. \ Derecha: $1\times10^{4}$ pasos.}
\end{frame}
...
\begin{frame}{Vicsek: componente gigante en función del ruido}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering\includegraphics[height=0.62\textheight,keepaspectratio]{S_eta_vicsek_super.png}\\
      {\scriptsize $\rho = 2,\ 4,\ 8$}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering\includegraphics[height=0.62\textheight,keepaspectratio]{S_eta_vicsek_sub.png}\\
      {\scriptsize $\rho = 1/\pi,\ 1/2\pi,\ 1/3\pi$}
    \end{column}
  \end{columns}
  \vspace{0.3em}
  \centering \params{Vicsek, \ 10 realizaciones por punto. \ Barras de error: desvío estándar entre realizaciones.}
\end{frame}
...
\begin{frame}{Votante: dinámica característica}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[height=0.52\textheight]{frame_voter_rho2_ordenado.png}\\[2pt]
      {\scriptsize $\eta = 0{,}05$}\\
      {\tiny\color{blue}\url{https://youtu.be/PENDIENTE-3}}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[height=0.52\textheight]{frame_voter_rho2_desordenado.png}\\[2pt]
      {\scriptsize $\eta = 1{,}0$}\\
...
\begin{frame}{Votante: evolución temporal de la polarización}
  \begin{columns}[c]
    \begin{column}{0.70\textwidth}
      \centering\includegraphics[height=0.72\textheight,keepaspectratio]{va_t_voter_rho2.png}
    \end{column}
    \begin{column}{0.28\textwidth}
      \params{
      Votante\\
...
\begin{frame}{Votante: polarización en función del ruido}
  \begin{columns}[c]
    \begin{column}{0.70\textwidth}
      \centering\includegraphics[height=0.72\textheight,keepaspectratio]{va_eta_voter.png}
    \end{column}
    \begin{column}{0.28\textwidth}
      \params{
      Votante\\
...
\begin{frame}{Votante: evolución temporal de la componente gigante}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering\includegraphics[height=0.62\textheight,keepaspectratio]{S_t_voter_rho2.png}\\
      {\scriptsize $\rho = 2$ \ ($N = 200$)}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering\includegraphics[height=0.62\textheight,keepaspectratio]{S_t_voter_rho1_pi.png}\\
      {\scriptsize $\rho = 1/\pi$ \ ($N = 32$)}
    \end{column}
  \end{columns}
  \vspace{0.3em}
  \centering \params{Votante, \ $L = 10$, \ $r_c = 1$. \ Izquierda: $2\times10^{3}$ pasos. \ Derecha: $1\times10^{4}$ pasos.}
\end{frame}
...
\begin{frame}{Votante: componente gigante en función del ruido}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \centering\includegraphics[height=0.62\textheight,keepaspectratio]{S_eta_voter_super.png}\\
      {\scriptsize $\rho = 2,\ 4,\ 8$}
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering\includegraphics[height=0.62\textheight,keepaspectratio]{S_eta_voter_sub.png}\\
      {\scriptsize $\rho = 1/\pi,\ 1/2\pi,\ 1/3\pi$}
    \end{column}
  \end{columns}
  \vspace{0.3em}
  \centering \params{Votante, \ 10 realizaciones por punto. \ Barras de error: desvío estándar entre realizaciones.}
\end{frame}
...
\begin{frame}{Comparación: polarización}
  \begin{columns}[c]
    \begin{column}{0.70\textwidth}
      \centering\includegraphics[height=0.72\textheight,keepaspectratio]{va_eta_comparacion.png}
    \end{column}
    \begin{column}{0.28\textwidth}
      \params{
      Línea llena: Vicsek\\
...
\begin{frame}{Comparación: componente gigante}
  \begin{columns}[c]
    \begin{column}{0.70\textwidth}
      \centering\includegraphics[height=0.72\textheight,keepaspectratio]{S_eta_comparacion_sub.png}
    \end{column}
    \begin{column}{0.28\textwidth}
      \params{
      Línea llena: Vicsek\\
...
\begin{frame}{Polarización en función de la componente gigante}
  \begin{columns}[c]
    \begin{column}{0.70\textwidth}
      \centering\includegraphics[height=0.72\textheight,keepaspectratio]{va_vs_S_comparacion.png}
    \end{column}
    \begin{column}{0.28\textwidth}
      \params{
      Círculos: Vicsek\\
...
\begin{frame}{Tiempo de ejecución del Cell Index Method}
  \begin{columns}[c]
    \begin{column}{0.68\textwidth}
      \centering\includegraphics[height=0.72\textheight,keepaspectratio]{benchmark_tp1_vs_tp2.png}
    \end{column}
...
\begin{frame}[plain]
  \vfill
  \centering
  {\usebeamerfont{title}\usebeamercolor[fg]{title} Muchas gracias}
  \vfill
\end{frame}
