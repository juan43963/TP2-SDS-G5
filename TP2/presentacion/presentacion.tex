...
\begin{frame}{Vicsek: dinámica característica}
  \begin{columns}[T]
    \begin{column}{0.36\textwidth}
      \animacion{frame_vicsek_rho2_ordenado.png}{1{,}0}{https://youtu.be/uBvohRpki4k}
    \end{column}
    \begin{column}{0.36\textwidth}
      \animacion{frame_vicsek_rho2_desordenado.png}{4{,}0}{https://youtu.be/kxyyiv_mvpU}
    \end{column}
...
\begin{frame}{Votante: dinámica característica}
  \begin{columns}[T]
    \begin{column}{0.36\textwidth}
      \animacion{frame_voter_rho2_ordenado.png}{0{,}05}{https://youtu.be/mp43AMcq_OY}
    \end{column}
    \begin{column}{0.36\textwidth}
      \animacion{frame_voter_rho2_desordenado.png}{1{,}0}{https://youtu.be/o8-64MBDwCY}
    \end{column}
    \begin{column}{0.26\textwidth}
      \params{$\rho = 2$ \ ($N = 200$)\\[6pt]Color según el ángulo de la velocidad.}
    \end{column}
