...
resuelve el modelo''. Los valores concretos son de C (diapositiva 9) y el motor
es de B (diapositivas 6 y 7). Si te adelantás, le sacás contenido a tus compañeros y
...
cada paso. El CIM no tiene diapositiva propia ---B lo nombra al pasar en la 6 y
reaparece recién en el benchmark de la 25---, así que si te preguntan por él en
la ronda de preguntas, la respuesta larga está en el cuadernillo 2.
